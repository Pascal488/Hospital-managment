...
-- Creating a structure of a table for appointiment

CREATE TABLE `appointiment` (
  `id` int(10) NOT NULL,
  `message` varchar(500) NOT NULL,
  `name` varchar(50) NOT NULL,
  `email` varchar(20) NOT NULL,
...
--
-- Table structure for table `employee`ALTER TABLE `complain`
